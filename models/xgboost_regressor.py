...
class XGBoostRegressorPredictor:
    ...
    def __init__(self):
        filepath = path.join(path.dirname(__file__), 'XGBOOSTRegressor.pickle')
    ...
    def get_request_data(self):
        ...
        return pd.DataFrame([[
            ...
            1 if interior_color == 16 else 0,
            # 'interior_color_Red': 0.0,
            1 if interior_color == 7 else 0,
            # 'interior_color_White': 0.0,
            1 if interior_color == 3 else 0,
            # 'make_name_BMW': 0.0,
        ...
        columns=XGBoostRegressorPredictor.cols)